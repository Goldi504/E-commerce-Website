      ...
      <div className='text-2xl text-center pt-8 border-t'>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-16'>
          ...
          <p>Forever was born out of a passion for innovation and a desire to revolutionize the way people shop online . 
            ...
            <p>Since our inception we've worked tirelessly to curate a diverse selection of high-quality product that cater to every taste and prefernce .
              From fashion and beauty to electronics and home essentials , we offers an extesive .</p>
