...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-10 lg:gap-20 pt-5 sm:pt-14 min-h-[80vh] border-t'>
    ...
    <input className='border border-gray-300 rounded py-1.5 w-full' type="text"  placeholder='Email address'/>
